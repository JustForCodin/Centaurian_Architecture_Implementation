# CA Experiment 1: Phi-4-mini Context Window Degradation Baseline
...
**Design implication:** For Phase 1 deployment of the CA architecture with a 7B SLM transducer, **the recommended SCI strategy is: episodic content delivered via RAG, persona JSON refreshed every ~15 turns**.
...
Based on Phase 2b results, the recommended SCI strategy for Phase 1 deployment of the CA architecture with a 7B SLM transducer:
