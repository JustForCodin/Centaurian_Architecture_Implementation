...
**Stimuli design:**
- 60 audio clips per condition (CA neural TTS, CA prosody-modulated, reference human speech, baseline Kokoro without QPM prosody)
...
**Expected outcomes:** The primary hypothesis is that QPM-modulated prosody increases naturalness MOS relative to baseline neural TTS without prosody modulation (target: MOS ≥ 3.8 for CA vs. ≥ 3.5 for unmodulated baseline).
...
- 5-minute video call interactions with either a CA instance or a human confederate matched on domain
