...
| **Persona Coherence Over Time** | Whether the agent presents as a consistent, recognizable persona across long and multi-session interactions (rather than whether it can be mistaken for human) | Human-computer interaction researchers | Planned (Experiment 7 — long-horizon episodic-RAG memory, 100–500 turns) |
