#!/usr/bin/env python3
"""
Experiment runner for CHA Experiment 2: 4-condition evaluation.
...
Loads the 30 evaluation scripts from CHA_Experiment_1/scripts/ (IDs 001-022 +
...
EXP1_SCRIPTS_DIR = BASE_DIR.parent / "CHA_Experiment_1" / "scripts"
...
def main():
    p = argparse.ArgumentParser(description="CHA Experiment 2 Runner")
    ...
    print("=" * 60)
    print(f"CHA Experiment 2 Runner — Condition {cond_key}")
