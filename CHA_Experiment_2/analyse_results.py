#!/usr/bin/env python3
"""
Analysis for CHA Experiment 2: 4-condition evaluation.
...
def write_summary_report(out_dir: Path, results: dict):
    lines: list[str] = []
    lines.append("# CHA Experiment 2 — Analysis Summary\n")
...
def main():
    p = argparse.ArgumentParser(description="CHA Experiment 2 analysis")
