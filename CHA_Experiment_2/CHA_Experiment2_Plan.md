...
graph TD
    subgraph "Training Phase"
        GEN["Dataset Generation<br/>(Claude Sonnet 4.5)<br/>10,000 examples"]
    ...
    subgraph "Evaluation Pipeline"
        ...
        JUDGE["Claude Haiku 4.5<br/>(primary judge)"]
...
|---|---|---|---|
| Train | 8,000 | Claude Sonnet 4.5 generation | Full distribution across dimensions and turn depths |
| Validation | 1,000 | Claude Sonnet 4.5 generation | Used for loss monitoring during training |
| Test (held-out) | 1,000 | Claude Sonnet 4.5 generation | Not used during training; for base capability check (H4) |
| **Total** | **10,000** | | |
...
|---|---|---|---|---|
| Conversation history generation | 10,000 | ~500 avg | ~800 avg | ~$28 |
| Target response generation | ~10,500 (with rejections) | ~1,200 avg | ~100 avg | ~$19 |
| Quality filter embedding | 10,500 | — | — | ~$0 (local MiniLM) |
| **Total dataset generation** | | | | **~$47** |
...
- Secondary judge (20% overlap): Claude Sonnet 4.5
...
|---|---|---|---|
| Primary judge (Haiku 4.5) | A, B, C, D × 960 probes | 3,840 | ~$1.20 |
| Secondary judge (Sonnet 4.5) | 20% overlap sample | 192 | ~$0.70 |
| Base capability test (Sonnet 4.5) | 50 prompts × 4 conditions | 200 | ~$0.80 |
| **Total evaluation cost** | | | **~$2.70** |
...
**Total: 2 weeks, ~$50 total cost ($47 dataset generation + $2.70 evaluation).**
